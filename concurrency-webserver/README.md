...
1. make the web server multi-threaded. Second, you
1.  implement different scheduling policies so that requests are serviced in
different orders. 
1. modify how the web server is invoked so that it can handle new input parameters (e.g., the number of threads to create).
